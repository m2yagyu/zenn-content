---
title: "まずLLMを自分の手で動かす"
---

物理の話に入る前に、対象を手元で動かしておきます。

この章だけは物理が一切出てきません。次章以降で `temperature` というつまみを回して測定していくので、その測定装置をまず組み立てる、という位置づけです。すでにLLMのAPIを叩いたことがある人は、読み飛ばして3章へ進んで構いません。
...
この章の元記事: [first-ai-chatbot-colab](https://zenn.dev/m2yagyu/articles/first-ai-chatbot-colab)
