...
ここから後半に入ります。扱う対象を言語から画像に移します。

2章と同じく、この章も物理は出てきません。次章で中身を開ける対象を、まず動かして手触りを掴んでおくための章です。画像生成をAPIで叩いたことがある人は、6章へ進んで構いません。
...
この章の元記事: [text-to-image-huggingface-colab](https://zenn.dev/m2yagyu/articles/text-to-image-huggingface-colab)
